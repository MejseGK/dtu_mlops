...
def main(cfg: DictConfig):
    ...
    # save weights
    #torch.save(model, os.path.join(out_dir, "trained_model.pt")) # saves entire model
    torch.save(model.state_dict(), os.path.join(out_dir, "trained_model.pt")) # only saves model weights
    ...
    save_image(x.view(batch_size, 1, 28, 28), os.path.join(out_dir, "orig_data.png"))
    save_image(x_hat.view(batch_size, 1, 28, 28), os.path.join(out_dir, "reconstructions.png"))
    ...
    save_image(generated_images.view(batch_size, 1, 28, 28), os.path.join(out_dir, "generated_sample.png"))
